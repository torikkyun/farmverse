...
export class CreateItemDto {
  ...
  @IsNotEmpty({ message: ItemValidationMessages.STOCK.NOT_EMPTY })
  @IsNumber({}, { message: ItemValidationMessages.STOCK.MUST_BE_NUMBER })
  @Min(0, { message: ItemValidationMessages.STOCK.MIN_VALUE })
